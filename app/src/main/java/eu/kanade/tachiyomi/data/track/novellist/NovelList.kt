...
class NovelList(id: Long) : BaseTracker(id, "NovelList"), NovelTracker {
    ...
    override fun getLogo(): Int = R.drawable.ic_tracker_novellist

    override fun getLogoColor(): Int = Color.rgb(33, 150, 243)
