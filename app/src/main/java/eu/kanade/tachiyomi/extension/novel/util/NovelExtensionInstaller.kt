...
internal class NovelExtensionInstaller(private val context: Context) {
        ...
        when (val installer = extensionInstaller.get()) {
            ...
            BasePreferences.ExtensionInstaller.PRIVATE -> {
                ...
                try {
                    ...
                    if (NovelExtensionLoader.installPrivateExtensionFile(context, tempFile)) {
                ...
                val intent =
                    NovelExtensionInstallService.getIntent(context, downloadId, uri, installer)
    ...
    fun cancelInstall(pkgName: String) {
        ...
        InstallerNovel.cancelInstallQueue(context, downloadId)
    }
