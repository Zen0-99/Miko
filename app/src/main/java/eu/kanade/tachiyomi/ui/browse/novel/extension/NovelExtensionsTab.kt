...
fun novelExtensionsTab(
    ...
    var privateExtensionToUninstall by remember { mutableStateOf<NovelExtension?>(null) }
        ...
        content = { contentPadding, _ ->
            NovelExtensionScreen(
                ...
                onLongClickItem = { extension ->
                    when (extension) {
                        is NovelExtension.Available -> extensionsScreenModel.installExtension(
                            extension,
                        )
                        else -> {
                ...
                onOpenExtension = { navigator.push(NovelExtensionDetailsScreen(it.pkgName)) },
            ...
            privateExtensionToUninstall?.let { extension ->
                NovelExtensionUninstallConfirmation(
...
@Composable
private fun NovelExtensionUninstallConfirmation(
